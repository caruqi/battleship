...
const FUNNY_WORDS = {
  1: ['Ы', 'Э', 'А', 'О', 'У', 'Ж', 'П'],
  2: ['НУ', 'ОЙ', 'ЭХ', 'ФУ', 'ГЫ', 'ХА', 'АХ', 'ОХ', 'УХ', 'ХИ', 'МУ', 'АЙ', 'ЧЁ'],
  3: [
    'БУХ', 'ПЫХ', 'ГАВ', 'МЯУ', 'ХРЮ', 'БУМ', 'ПУФ', 'ФЫР',
    'ПЕС', 'КИК', 'ЛОЛ', 'ХАМ', 'ЧАЙ', 'БЛЯ', 'ЧИХ', 'ПФФ',
    'ОРУ', 'РЖУ', 'ПУК', 'ХЛЮ', 'УПС',
  ],
  4: [
    'ШМЯК', 'ПШИК', 'КВАК', 'ХРЮК', 'ГЫГЫ', 'ГРОМ',
    'КОВШ', 'ПУКИ', 'БУМС', 'БОБР', 'БДЫЩ', 'ХЛОП', 'ЧПОК', 'ШЛЁП', 'ТЫДЫ',
  ],
};
